#### Script to run the codes to create the graphs ####
...
variables_names <- colnames(data_all_joined[,6:23])
...
variables_names <- colnames(data_all_joined[,6:12])
